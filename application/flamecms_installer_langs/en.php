...
/*Footer*/
__s('Made by','');
__s('with love and caffeine.','');
__s('Licensed under','');
__s('GNU license','');
__s('Copyright FlameCMS','');
__s('All rights Reserved','');
/*Install step 1*/
...
__s('Ups... it apears that you have some unsatisfied requirements...','');
__s('please talk to you host provider in order to install them.','');
/*Install Step 3*/
__s('Required','');
...
__s('[CMS] Mysql User','');
__s('dbuser','');
__s('[CMS] Mysql Password','');
__s('excelentPassword','');
__s('[CMS] Mysql Port','');
__s('Port','');
