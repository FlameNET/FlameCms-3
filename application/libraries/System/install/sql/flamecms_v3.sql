...
-- ----------------------------
-- Table structure for v3_auto_login
-- ----------------------------
DROP TABLE IF EXISTS `v3_auto_login`;
CREATE TABLE `v3_auto_login` (
  ...
  KEY `UUID` (`UUID`),
  CONSTRAINT `v3_auto_login_ibfk_1` FOREIGN KEY (`UUID`) REFERENCES `v3_user_login` (`UUID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of v3_auto_login
-- ----------------------------
...
CREATE TABLE `v3_forum` (
  ...
  CONSTRAINT `v3_forum_ibfk_3` FOREIGN KEY (`created_by`) REFERENCES `v3_user_login` (`UUID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `v3_forum_messages` (
  ...
  CONSTRAINT `v3_forum_messages_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `v3_user_login` (`UUID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for v3_sessions
-- ----------------------------
...
CREATE TABLE `v3_settings` (
  ...
  CONSTRAINT `v3_settings_ibfk_1` FOREIGN KEY (`modified_by`) REFERENCES `v3_user_login` (`UUID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `v3_settings` VALUES ('00000000005', 'cms_multilang', 'true', 'b', null, null);
...
INSERT INTO `v3_settings` VALUES ('00000000013', 'cms_version_type', 'pre_alpha', 's', null, null);
INSERT INTO `v3_settings` VALUES ('00000000014', 'cms_update_server', 'https://api.github.com/repos/FlameNET/FlameCms-3/releases', 's', null, null);
INSERT INTO `v3_settings` VALUES ('00000000015', 'cms_enable_alpha_features', 'true', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000016', 'cms_enable_beta_features', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000017', 'cms_enable_charlie_features', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000018', 'cms_enable_release_features', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000019', 'cms_quick_notifications', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000020', 'cms_ajax_security', 'true', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000021', 'cms_plugins', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000022', 'cms_themes', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000023', 'cms_uploads', 'true', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000024', 'cms_hide_flame_credits', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000025', 'cms_custom_copyright', '{\'value\':false,\'msg\':\'\'}', 'j', null, null);
INSERT INTO `v3_settings` VALUES ('00000000026', 'cms_advanced_paypal', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000027', 'cms_advanced_enablement_key', '{\'value\':false,\'key\':\'\'}', 'j', null, null);
INSERT INTO `v3_settings` VALUES ('00000000028', 'cms_maintenance_mode', '{\'value\':false,\'msg\':\'\'}', 'j', null, null);
INSERT INTO `v3_settings` VALUES ('00000000029', 'cms_enable_wysiwyg', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000030', 'cms_utc', 'UTC+0', 's', null, null);
INSERT INTO `v3_settings` VALUES ('00000000031', 'cms_root_change_password', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000032', 'cms_enable_menu_managment', 'true', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000033', 'cms_enable_ceo', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000034', 'cms_enable_updates', 'true', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000035', 'cms_support_verification_mode', 'checksum', 's', null, null);
INSERT INTO `v3_settings` VALUES ('00000000036', 'cms_paid_support', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000037', 'cms_geoip_tracking', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000038', 'cms_log_user_login', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000039', 'cms_ban_ip_for', '15m', 's', null, null);
INSERT INTO `v3_settings` VALUES ('00000000040', 'cms_facebook_login', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000041', 'cms_splashframe_login', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000042', 'cms_google_login', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000043', 'cms_enable_app_support', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000044', 'cms_log_user_actions', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000045', 'cms_log_update_checks', 'true', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000046', 'cms_favion', '', 's', null, null);
INSERT INTO `v3_settings` VALUES ('00000000047', 'cms_xls_export_enable', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000048', 'cms_rss_enable', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000049', 'cms_pps_type', '3', 's', null, null);
INSERT INTO `v3_settings` VALUES ('00000000050', 'cms_subdomain_per_language', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000053', 'cms_enable_localstorage_key', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000054', 'cms_user_session_tracking', 'false', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000055', 'cms_platform_tracking', 'true', 'b', null, null);
INSERT INTO `v3_settings` VALUES ('00000000056', 'cms_install_id', '1', 'i', null, null);

-- ----------------------------
-- Table structure for v3_slideshow
-- ----------------------------
DROP TABLE IF EXISTS `v3_slideshow`;
CREATE TABLE `v3_slideshow` (
  ...
  KEY `UUID` (`UUID`),
  KEY `news_id` (`news_id`),
  CONSTRAINT `v3_slideshow_ibfk_1` FOREIGN KEY (`UUID`) REFERENCES `v3_user_login` (`UUID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `v3_slideshow_ibfk_2` FOREIGN KEY (`news_id`) REFERENCES `v3_blog_content` (`blog_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of v3_slideshow
-- ----------------------------
...
CREATE TABLE `v3_system_perms` (
  ...
  CONSTRAINT `v3_system_perms_ibfk_1` FOREIGN KEY (`perm_addered_by`) REFERENCES `v3_user_login` (`UUID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of v3_system_perms
-- ----------------------------
INSERT INTO `v3_system_perms` VALUES ('administrator', '00000000000', 'a', '', '0000-00-00 00:00:00', null);
...
CREATE TABLE `v3_system_roles` (
  ...
  CONSTRAINT `v3_system_roles_ibfk_2` FOREIGN KEY (`role_modified_by`) REFERENCES `v3_user_login` (`UUID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `v3_system_roles_ibfk_3` FOREIGN KEY (`role_addered_by`) REFERENCES `v3_user_login` (`UUID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of v3_system_roles
-- ----------------------------
INSERT INTO `v3_system_roles` VALUES ('00000000000', 'Banned', '00000000000', '0', '[BANNED]', null, null, null, '2016-11-06 20:38:37');
INSERT INTO `v3_system_roles` VALUES ('00000000001', 'Player', '00000000000', '0', '[player]', null, null, null, '2016-11-06 20:38:37');
INSERT INTO `v3_system_roles` VALUES ('00000000002', 'Moderator', '00000000000', '0', '[MOD]', null, null, null, '2016-11-06 20:38:37');
INSERT INTO `v3_system_roles` VALUES ('00000000003', 'Game Master', '00000000000', '1', '[GM]', null, null, null, '2016-11-06 20:38:37');
INSERT INTO `v3_system_roles` VALUES ('00000000004', 'Forum Moderator', '00000000000', '0', '[FORUM MOD]', null, null, null, '2016-11-06 20:38:37');
INSERT INTO `v3_system_roles` VALUES ('00000000005', 'Forum Game Master', '00000000000', '0', '[FORUM GM]', null, null, null, '2016-11-06 20:38:37');
INSERT INTO `v3_system_roles` VALUES ('00000000006', 'Hidden Game Master', '00000000000', '1', '[player]', null, null, null, '2016-11-06 20:38:37');
INSERT INTO `v3_system_roles` VALUES ('00000000007', 'Administrator', '00000000000', '2', '[ADMIN]', null, null, null, '2016-11-06 20:38:37');
INSERT INTO `v3_system_roles` VALUES ('00000000008', 'Forum Administrator', '00000000000', '1', '[FORUM ADMIN]', null, null, null, '2016-11-06 20:38:37');
INSERT INTO `v3_system_roles` VALUES ('00000000009', 'Hidden Administrator', '00000000000', '2', '[player]', null, null, null, '2016-11-06 20:38:37');
INSERT INTO `v3_system_roles` VALUES ('00000000010', 'Hidden Owner', '00000000000', '3', '[player]', null, null, null, '2016-11-06 20:38:37');
INSERT INTO `v3_system_roles` VALUES ('00000000011', 'Owner', '00000000000', '3', '[OWNER]', null, null, null, '2016-11-06 20:38:37');
INSERT INTO `v3_system_roles` VALUES ('00000000012', 'Hidden ROOT', '00000000000', '3', '[Player]', null, null, null, '2016-11-06 20:38:37');
